...
async fn test_ai_turn_state_transitions_to_game_over_if_no_moves() {
    ...
    session.game.board.set_piece(7, 7, Some(checkers_rs::core::piece::Piece::new(Color::White)));
...
async fn test_ai_turn_state_handles_ai_error() {
    ...
    session.game.board.set_piece(5, 0, Some(checkers_rs::core::piece::Piece::new(Color::Black)));
